...
export function HeroSection() {
  return (
    <section className="relative overflow-hidden rounded-[32px] border border-botanical-100 bg-gradient-to-br from-botanical-50 via-cream to-parchment px-6 py-16 lg:px-20 lg:py-24 sm:py-20 shadow-premium">
      {/* WebGL Antigravity Layer */}
      <HeroWebGL />
      
      {/* Fallback CSS shapes removed for WebGL */}
      ...
      <div className="relative mx-auto grid max-w-[85rem] gap-12 lg:grid-cols-[1fr_1fr] lg:gap-20 items-center">
        <motion.div 
          ...
          animate="show"
        >
          <motion.p variants={fadeUp} className="text-[11px] font-semibold uppercase tracking-[0.43em] text-botanical-500 mb-8">
            {brand.shortTagline}
          </motion.p>
          <motion.h1
            variants={fadeUp}
          ...
          <motion.div variants={fadeUp} className="mt-12 hidden lg:block border-t border-botanical-200/50 pt-8">
            <TrustBadgeStrip />
          </motion.div>
        </motion.div>
